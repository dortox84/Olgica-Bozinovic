        ...
        >
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8 lg:gap-12">
            ...
            <div className="max-w-[620px]">
              ...
              {/* Badge: "New Collection" equivalent in Russian */}
              <div 
              ...
              {/* Title: "Ready to Elevate Your Style?" translated to Health context */}
              <h2 
                id="cta-heading-title"
                className="mt-4 sm:mt-5 text-2xl sm:text-3xl lg:text-4xl xl:text-[42px] font-bold text-white tracking-tight leading-[1.15]"
              >
                Готовы восстановить здоровье и энергию?
              </h2>
