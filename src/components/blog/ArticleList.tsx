...
import { UnorderedListBlock, OrderedListBlock } from '../../types/blog';
import { Check } from 'lucide-react';

export const ArticleUnorderedList: React.FC<UnorderedListBlock> = ({ items }) => {
  return (
...
export const ArticleOrderedList: React.FC<OrderedListBlock> = ({ items }) => {
  return (
